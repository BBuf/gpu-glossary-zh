...
![在此图的四个时钟周期中，有三个周期发射了指令，因此发射效率为75%。该图灵感来源于GTC 2025上的[*CUDA Techniques to Maximize Compute and Instruction Throughput*](https://www.nvidia.com/en-us/on-demand/session/gtc25-s72685/)演讲。](../images/cycles.svg)
