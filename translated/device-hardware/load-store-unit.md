...
![H100 流式多处理器 (SM) 的内部架构。图中粉色部分展示了加载/存储单元以及[特殊功能单元](/gpu-glossary/device-hardware/special-function-unit)。改编自 NVIDIA 的 [H100 白皮书](https://modal-cdn.com/gpu-glossary/gtc22-whitepaper-hopper.pdf)。](../images/gh100-sm.svg)
